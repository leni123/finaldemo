  ...
  template: `
    <header class="navbar sticky-top mt-4 flex-md-nowrap p-0 shadow">
      <a
        ...
        href="#"><img src="assets/images/manaoag-seal.png" alt="DIGICARE Logo" style="width: 70px; height: auto;" ></a>
      <a class="nav-link" routerLink=admin align-items="left"> <i class="fas fa-user-shield"></i> Admin</a>
      <button
